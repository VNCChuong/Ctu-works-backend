...
const getAllRecruiter = async (req, res) => {
  try {
    ...
    const response = await RecruiterService.getAllRecruiter(page, pagesize);
    return res.status(200).json(response);
  } catch (e) {
    return res.status(404).json({
      message: e,
...
const createLocation = async (req, res) => {
  try {
    ...
    const response = await RecruiterService.createLocation(
      recruiterId,
      req.body
    );
    return res.status(200).json(response);
...
const updateLocation = async (req, res) => {
  try {
    ...
    const response = await RecruiterService.updateLocation(
      recruiterId,
      locationId,
      data
    );
