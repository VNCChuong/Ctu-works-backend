...
const updateUserWorkPreferences = async (req, res) => {
  try {
    ...
    const response = await UserService.updateUserWorkPreferences(
      userId,
      req.body
    );
    return res.status(200).json(response);
...
const updateWorkingHistories = async (req, res) => {
  try {
    ...
    const response = await UserService.updateWorkingHistories(
      userId,
      workingHistoriesId,
      data
    );
...
const deleteWorkingHistories = async (req, res) => {
  try {
    ...
    const response = await UserService.deleteWorkingHistories(
      userId,
      workingHistoriesId
    );
    return res.status(200).json(response);
...
const updateEducations = async (req, res) => {
  try {
    ...
    const response = await UserService.updateEducations(
      userId,
      educationsId,
      data
    );
...
const updateCertifications = async (req, res) => {
  try {
    ...
    const response = await UserService.updateCertifications(
      userId,
      certificationsId,
      data
    );
...
const deleteCertifications = async (req, res) => {
  try {
    ...
    const response = await UserService.deleteCertifications(
      userId,
      certificationsId
    );
    return res.status(200).json(response);
...
const updateActivities = async (req, res) => {
  try {
    ...
    const response = await UserService.updateActivities(
      userId,
      activitiesId,
      data
    );
