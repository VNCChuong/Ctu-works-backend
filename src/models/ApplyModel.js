...
const applySchema = new mongoose.Schema({
    ...
    workingPreferencesId: { type: mongoose.Schema.Types.ObjectId, ref: 'UserWorkPreference', required: true },
    userInfoId: { type: mongoose.Schema.Types.ObjectId, ref: 'UserInfo', required: true },
