...
router.put(
  "/update-work-preferences/:id",
  UserController.updateUserWorkPreferences
);
...
router.post(
  "/create-working-histories/:id",
  UserController.createWorkingHistories
);
router.put(
  "/update-working-histories/:id",
  UserController.updateWorkingHistories
);
router.delete(
  "/delete-working-histories/:id",
  UserController.deleteWorkingHistories
);
...
router.delete(
  ...
  UserController.deleteCertifications
);
